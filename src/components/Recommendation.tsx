...
export default function Recommendation({
  ...
  const allScooters = use(scooters);
  ...
  const handleAnswer = (value: string) => {
    ...
    if (currentQuestion.type === "multiple") {
      ...
      if (currentValues.includes(value)) {
        newAnswers[currentQuestion.id] = currentValues.filter(
          (v) => v !== value
        );
      } else {
  ...
  const handleNext = () => {
    if (currentStep < allQuestions.length - 1) {
      ...
      const results = calculateScores(answers, allScooters);
    ...
    return (
      <div className="relative -mx-6 sm:mx-auto w-[calc(100%+3rem)] sm:w-full sm:max-w-5xl sm:rounded-xl border border-slate-100 bg-white/95 p-6 sm:p-10 shadow-2xl shadow-slate-900/5">
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between mb-10">
          <div>
            ...
            <h1 className="mt-2 text-3xl font-bold text-slate-900">
              Rekomendasi Scooter untuk kamu
            </h1>
            <p className="mt-2 text-slate-500">
              Top 3 Ninebot yang paling sesuai berdasarkan jawaban quiz dan
              preferensi harian kamu.
            </p>
          </div>
        </div>
        ...
        {recommendations.map((result, index) => (
          <div
            key={result.scooter.id}
            className="mb-8 rounded-lg border border-slate-100 bg-white p-6 lg:p-7 shadow-xl shadow-slate-900/5"
          >
            <div>
                ...
                <div className="max-h-full overflow-hidden flex flex-col bg-white border border-gray-200 shadow-2xl rounded-xl pointer-events-auto">
                  ...
                  <div className="p-4 overflow-y-auto">
                      ...
                      <div className="mb-6">
                        <div className="relative w-full h-64 rounded-xl border border-slate-100 bg-slate-50">
                          <Image
                            ...
                            alt={selectedResult.scooter.model}
                            fill
                            className="object-contain p-6"
                            sizes="(max-width: 768px) 100vw, 50vw"
                          />
                          ...
                          <div className="grid grid-cols-2 gap-4">
                            <div>
                              ...
                              <p className="text-base font-semibold text-slate-900">
                                {selectedResult.scooter.battery_capacity
                                  ? `${selectedResult.scooter.battery_capacity} Wh`
                                  : "-"}
                              </p>
                            </div>
                          </div>
                        ...
                        <div className="rounded-lg border border-slate-100 p-4">
                          ...
                          <div className="grid grid-cols-2 gap-4">
                            <div>
                              ...
                              <p className="text-base font-semibold text-slate-900">
                                {selectedResult.scooter.power_nominal
                                  ? `${selectedResult.scooter.power_nominal} W`
                                  : "-"}
                              </p>
                            </div>
                            <div>
                              ...
                              <p className="text-base font-semibold text-slate-900">
                                {selectedResult.scooter.power_max
                                  ? `${selectedResult.scooter.power_max} W`
                                  : "-"}
                              </p>
                            </div>
                            <div>
                              ...
                              <p className="text-base font-semibold text-slate-900">
                                {selectedResult.scooter.speeds?.at(-1)
                                  ? `${selectedResult.scooter.speeds?.at(
                                      -1
                                    )} km/h`
                                  : "-"}
                              </p>
                            ...
                            <div>
                              ...
                              <p className="text-base font-semibold text-slate-900">
                                {selectedResult.scooter.ranges?.at(-1)
                                  ? `${selectedResult.scooter.ranges?.at(
                                      -1
                                    )} km`
                                  : "-"}
                              </p>
                          ...
                          <div className="grid grid-cols-2 gap-4">
                            <div>
                              ...
                              <p className="text-base font-semibold text-slate-900 capitalize">
                                {selectedResult.scooter.front_brake.replace(
                                  /_/g,
                                  " "
                                )}
                              </p>
                            ...
                            <div>
                              ...
                              <p className="text-base font-semibold text-slate-900 capitalize">
                                {selectedResult.scooter.rear_brake.replace(
                                  /_/g,
                                  " "
                                )}
                              </p>
                        ...
                        <div className="rounded-lg border border-slate-100 p-4">
                          ...
                          <div className="grid grid-cols-2 gap-4">
                            <div>
                              ...
                              <p className="text-base font-semibold text-slate-900">
                                {selectedResult.scooter.tire_size
                                  ? `${
                                      selectedResult.scooter.tire_size / 2.54
                                    }"`
                                  : "-"}{" "}
                                •{" "}
                                {selectedResult.scooter.tire_type.replace(
                                  /_/g,
                                  " "
                                )}
                              </p>
                            ...
                            <div>
                              ...
                              <p className="text-base font-semibold text-slate-900 capitalize">
                                {selectedResult.scooter.suspension === "none"
                                  ? "Tidak ada"
                                  : selectedResult.scooter.suspension.replace(
                                      /_/g,
                                      " "
                                    )}
                              </p>
                        ...
                        <div className="rounded-lg border border-slate-100 p-4">
                          ...
                          <div className="grid grid-cols-2 gap-4">
                            <div>
                              ...
                              <p className="text-base font-semibold text-slate-900">
                                {selectedResult.scooter.ip_body || "-"}
                              </p>
                            </div>
                            <div>
                              <p className="text-xs text-slate-500 uppercase">
                              ...
                              <p className="text-base font-semibold text-slate-900">
                                {selectedResult.scooter.ip_battery || "-"}
                              </p>
                            </div>
                          </div>
                        </div>
                        ...
                        <div className="rounded-lg border border-slate-100 p-4">
                          ...
                          <div className="grid grid-cols-2 gap-4">
                            <div>
                              ...
                              <p className="text-base font-semibold text-slate-900">
                                {selectedResult.scooter.max_payload
                                  ? `${selectedResult.scooter.max_payload} kg`
                                  : "-"}
                              </p>
                            </div>
                            <div>
                              ...
                              <p className="text-base font-semibold text-slate-900">
                                {selectedResult.scooter.weight
                                  ? `${selectedResult.scooter.weight} kg`
                                  : "-"}
                              </p>
                            </div>
                            {selectedResult.scooter.dimension && (
                              <div>
                                <p className="text-xs text-slate-500 uppercase">
                                  Dimensi Terbuka
                                </p>
                                <p className="text-base font-semibold text-slate-900">
                                  {selectedResult.scooter.dimension.join(" x ")}{" "}
                                  mm
                                </p>
                              </div>
                            )}
                            {selectedResult.scooter.dimension_folded && (
                              <div>
                                <p className="text-xs text-slate-500 uppercase">
                                  Dimensi Terlipat
                                </p>
                                <p className="text-base font-semibold text-slate-900">
                                  {selectedResult.scooter.dimension_folded.join(
                                    " x "
                                  )}{" "}
                                  mm
                                </p>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      {selectedResult.scooter.pros?.length && (
                      ...
                      {selectedResult.scooter.cons?.length && (
                        <div className="rounded-lg border border-rose-100 bg-rose-50/80 p-4">
                          <h3 className="font-semibold mb-2 text-rose-900">
                            Kekurangan
                          </h3>
                  ...
                  {option.value && (
                    ...
                    >
                      {currentQuestion.type === "single"
                        ? "Klik untuk memilih opsi ini"
                        : "Klik untuk menambah/kurangi pilihan"}
                    </p>
                  )}
                </div>
              </button>
